...
#include "graphs/treewidth/array_id_func.h"
#include "graphs/treewidth/tiny_id_func.h"
#include "graphs/treewidth/permutation.h"
#include "graphs/treewidth/heap.h"
#include <vector>
#include <iostream>
...
//	std::cerr << "computing compute_greedy_min_degree_order" << std::endl;
...
//	std::cerr << "computing compute_greedy_min_shortcut_order" << std::endl;
