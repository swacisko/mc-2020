...
#include "graphs/treewidth/io_helper.h"
#include "graphs/treewidth/multi_arc.h"
#include "graphs/treewidth/id_multi_func.h"
...
ListGraph uncached_load_pace_graph(const std::string &file_name, std::istream & def_str) {
	return load_uncached_text_file(file_name, load_pace_graph_impl, def_str);
}
